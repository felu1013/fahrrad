...
const graphqlSrc = join(src, 'fahrrad', 'graphql');
const graphqlDist = join(dist, src, 'fahrrad', 'graphql');
mkdirSync(graphqlDist, { recursive: true });
copyFileSync(join(graphqlSrc, 'fahrrad.graphql'), join(graphqlDist, 'fahrrad.graphql'));
